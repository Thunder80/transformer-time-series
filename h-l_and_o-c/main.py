...
def main():
    ...
    train_loader, time_series_data = prepare_data(input_sequence_length=input_sequence_length, output_sequence_length=output_sequence_length, file_path="../data/spinning_top/AXISBANK.NS_train_spinning_top.csv", batch_size=batch_size, feature_names=["Open", "High", "Low", "Close", "Volume", "PriceDifference", "ShadowSize", "IsSpinningTop"], device=device)
