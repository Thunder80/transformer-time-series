...
data = pd.read_csv('../data/axis/AXISBANK.NS_all_data.csv')  # Replace 'stock_data.csv' with your file name
...
data.to_csv(f"../data/doji/AXISBANK.NS_{name}.csv")
train_filename = f"../data/doji/AXISBANK.NS_train_{name}.csv"
test_filename = f"../data/doji/AXISBANK.NS_test_{name}.csv"
