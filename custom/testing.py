...
from custom.predict import predict_multi
...
def test_model_multi(model, time_series_data, criterion, input_sequence_length, output_sequence_length, feature_size, device, root_folder, daily_features, weekly_features, time_series_data_weekly):
    create_empty_directory(f"{root_folder}/predictions/test")
    with torch.no_grad():
