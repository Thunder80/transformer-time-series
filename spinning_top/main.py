...
def main():
    ...
    train_loader, time_series_data = prepare_training_data(input_sequence_length, output_sequence_length, "../data/spinning_top/AXISBANK.NS_train_spinning_top.csv", batch_size=batch_size, device=device)
